...
public class Board {
	...
	public Board(int b_code, int user_code, String user_id, int b_ccode, String title, String content, Date bDate,
			int readCount, List<Comment> comments, String status, String originalFileName, String renamedFileName) {
		super();
		this.b_code = b_code;
