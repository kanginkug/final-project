...
<!-- 페이지부 시작 -->
    <div style="margin-top:50px; margin-left:400px; padding-bottom:50px; font-family: 'GmarketSansMedium'!important;">
        <nav aria-label="Page navigation example">
            ...
            <!-- 맨처음 -->
                <li class="page-item">
                    <a class="page-link" onclick="movePage('${path}/board/list?page=1')"><i class="fa fa-angle-left"></i><i class="fa fa-angle-left"></i></a>
                </li>
            ...
            <!-- 마지막 페이지 -->
                <li class="page-item">
                    <a class="page-link" onclick="movePage('${path}/board/list?page=${pageInfo.getEndPage()}')"> <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
                </li>
            </ul>
        </nav>
    </div>
