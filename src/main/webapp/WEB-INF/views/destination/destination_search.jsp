						...
						<div class="card h-100 border-0 shadow">
							<div class="card-img-top overflow-hidden dark-overlay bg-cover"
								...
								<div class="card-img-overlay-bottom z-index-20">
									...
									<p class="mb-2 text-xs">
											<c:if test="${d.readCount > 0 && d.readCount < 1000}">
	                                    		...
	                                    		<c:if test="${d.readCount > 999 && d.readCount < 2000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${d.readCount > 1999 && d.readCount < 3000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    		
	                                    			<i class="fa fa-star text-gray-300 "></i>
	                                    		...
	                                    		<c:if test="${d.readCount > 2999 && d.readCount < 4000}">
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
	                                    			<i class="fa fa-star text-warning "></i>	                                    			
							...
							<div class="card-body">
								...
								<p class="text-sm text-muted text-uppercase mb-1">
									By <a class="text-dark">BOOGIRANG</a>
								</p>
								<p class="text-sm mb-0">
									<a class="mr-1">Destination,</a>
									<a class="mr-1">Contemporary</a>
								</p>
							</div>
						</div>
					</div>
