...
<jsp:include page="/WEB-INF/views/common/header.jsp"/>	
                    ...
                    <div class="text-block">
                        ...
                        <div class="row gallery ms-n1 me-n1">
                            <div class="col-lg-4 col-6 px-1 mb-2">
                                <a href="${restaurant.img_thumb}"><img class="img-fluid" style="height:159px; width:288px;" src="${restaurant.img_thumb}" alt="..."></a>
                            </div>
                            <div class="col-lg-4 col-6 px-1 mb-2">
                                <a href="${path}/resources/img/Busan/detail1.jpg"><img class="img-fluid" style="height:159px;  width:288px;" src="${path}/resources/img/Busan/detail1.jpg" alt="..."></a>
                            </div>
                            <div class="col-lg-4 col-6 px-1 mb-2">
                                <a href="${path}/resources/img/Busan/detail2.jpg"><img class="img-fluid" style="height:159px;  width:288px;" src="${path}/resources/img/Busan/detail2.jpg" alt="..."></a>
                            </div>
                            <div class="col-lg-4 col-6 px-1 mb-2">
                                <a href="${path}/resources/img/Busan/detail6.png"><img class="img-fluid" style="height:159px;" src="${path}/resources/img/Busan/detail6.png" alt="..."></a>
                            </div>
                            <div class="col-lg-4 col-6 px-1 mb-2">
                                <a href="${path}/resources/img/Busan/detail4.jpg"><img class="img-fluid" src="${path}/resources/img/Busan/detail4.jpg" alt="..."></a>
                            </div>
                            <div class="col-lg-4 col-6 px-1 mb-2">
                                <a href="${path}/resources/img/Busan/detail5.jpg"><img class="img-fluid" src="${path}/resources/img/Busan/detail5.jpg" alt="..."></a>
                            </div>
    ...
    <section class="py-3 bg-gray-100" style="font-family: 'GmarketSansMedium'!important;">
                    <div class="container">
                                    ...
                                    <div class="w-100 h-100 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
                                        <div class="card h-100 border-0 shadow">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="text-sm mb-0"><a class="me-1" href="${path}/res/view?no=${restaurant.res_id}">상세보기<i class="fa fa-chevron-right ms-2"></i></a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
