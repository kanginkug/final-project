                ...
                <div class="col-lg-7">
                    ...
                    <div class="text-block">
                        ...
                        <p class="text-center mb-5">
                            <a class="btn btn-primary mx-2 mb-2" href="${path}/mem/myReservation?user_CODE=${loginMember.user_CODE}"> <i class="far fa-file me-2"></i>예약 확인</a><a class="btn btn-outline-muted mb-2" href="${path}/room/list">다른 숙소 보기</a></p>
